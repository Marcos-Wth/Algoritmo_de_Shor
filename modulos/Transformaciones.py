...
# Resultado correcto :      N = 21, nQ = 10, a = 2, c = 171
# Periodo no encontrado:    N = 33, nQ = 10, a = 5, c = 7
# Periodo es par:           N = 33, nQ = 10, a = 16, c = 205
# Primos erroneos:          N = 21, nQ = 10, a = 16, c = 171 

# pruebaExtra=Transformaciones()
# solExtra=pruebaExtra.obtener_primos()
# print(solExtra[3])